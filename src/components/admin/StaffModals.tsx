  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-xl w-96">
        ...
        <input className="w-full p-2 border rounded mb-2 dark:bg-slate-800" placeholder="नाम" value={name} onChange={e => setName(e.target.value)} />
        <input className="w-full p-2 border rounded mb-2 dark:bg-slate-800" placeholder="ईमेल" value={email} onChange={e => setEmail(e.target.value)} />
        <input className="w-full p-2 border rounded mb-4 dark:bg-slate-800" placeholder="पासवर्ड" type="password" value={password} onChange={e => setPassword(e.target.value)} />
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-xl w-96">
        ...
        <input className="w-full p-2 border rounded mb-4 dark:bg-slate-800" placeholder="नया पासवर्ड" type="password" value={password} onChange={e => setPassword(e.target.value)} />
        <div className="flex justify-end gap-2">
          <button className="px-4 py-2 bg-slate-200 dark:bg-slate-700 rounded" onClick={onClose}>Cancel</button>
