    ...
    <section className="w-full max-w-[1440px] mx-auto px-4 md:px-8 py-8 mb-4">
      ...
      >
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12">
          ...
          <div className="w-full md:w-[60%] flex flex-col items-center md:items-start justify-center text-center md:text-left">
            ...
            <p className="text-lg md:text-xl font-black font-hindi text-slate-600 dark:text-slate-300 tracking-wide mt-3 md:mt-2 md:pl-2">
              खबर नहीं, हकीकत
            </p>
          </div>
