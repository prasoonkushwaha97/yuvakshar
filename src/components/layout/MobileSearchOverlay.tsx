...
import { Search, X, Clock, TrendingUp, User, ArrowLeft, BookOpen, MessageSquare, Newspaper, Tag, Folder, Users, Mic, AlertCircle, BadgeCheck } from "lucide-react";
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        {authors.slice(0, 3).map(author => (
                          <div key={author.id} className="flex items-center gap-2 group w-full p-2 rounded-xl bg-slate-50 dark:bg-slate-800/50 focus-within:bg-slate-100 dark:focus-within:bg-slate-800 transition-colors">
                            <button
                              data-search-item="true"
                              onKeyDown={handleKeyboardNav}
                            ...
                            >
                              {author.thumbnail ? (
                                <img src={author.thumbnail} className="w-10 h-10 rounded-full object-cover shrink-0" />
                              ) : (
                              ...
                              <div className="flex-grow min-w-0">
                                <div className="flex items-center gap-1.5">
                                  <h4 className="text-slate-900 dark:text-slate-100 font-semibold font-hindi text-sm line-clamp-1">
                            ...
                            <button
                              ...
                              className="shrink-0 px-3 py-1.5 bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-semibold rounded-full hover:bg-slate-300 dark:hover:bg-slate-600 transition-colors"
                            >
                              Follow
                            </button>
                          </div>
