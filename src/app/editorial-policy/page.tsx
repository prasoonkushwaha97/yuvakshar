...
import { BookOpen, HelpCircle, FileText, CheckCircle, ArrowDown, User, ShieldCheck, UserCheck, CheckSquare, Scale, Award, Globe, Share2, MessageSquare, Eye, FileEdit, RefreshCw, Database, Ban } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 space-y-10">
        ...
        <div className="space-y-6 text-sm md:text-base leading-relaxed text-slate-700 dark:text-slate-300 font-serif space-y-6">
          ...
          <p className="text-justify font-hindi">
            Yuvakshar का प्रमुख उद्देश्य भारतीय पाठकों को उच्च-गुणवत्ता, विश्वसनीय तथा विविध विचार-विमर्श से परिपूर्ण सामग्री उपलब्ध कराना है। प्रसार के इस माध्यम के रूप में, हम साहित्य, समाचार और सांस्कृतिक विमर्श पर केंद्रित होंगे। भारतीय प्रेस परिषद के अनुसार, “पत्रकारिता का मूल उद्देश्य जनता को सार्वजनिक हित के विषयों पर निष्पक्ष, सटीक, बिना पक्षपात के, संयत एवं सभ्य भाषा में समाचार, विचार और जानकारी प्रदान करना है”। इसी आदर्श पर चलते हुए, Yuvakshar पत्रकारिता और साहित्य दोनों में मानक स्थापित करता है। BBC की एडिटोरियल गाइडलाइन्स भी इस सिद्धांत को दोहराती हैं कि श्रोताओं को “उच्चतम मानकों” के समाचार की उम्मीद होती है और इसलिए “निष्पक्षता, सत्यता और सटीकता” को प्राथमिकता देना चाहिए। अतः हमारी सामग्री का स्वरूप ऐसा होगा जो हिंदुस्तानी समाज की विविधता और बहुलता को समेटे, और पाठकों में विश्वास बनाए रखे।
          </p>
          ...
          <p className="text-justify font-hindi">
            Yuvakshar में संपादकीय निर्णय पूरी तरह से स्वतंत्र होंगे। मालिकाना संगठन (Owner) होते हुए भी सभी समाचार निर्णयों पर केवल संपादकीय टीम का प्रभुत्व होगा। किसी भी बाहरी हित समूह, राजनीतिक दबाव या वाणिज्यिक पक्षपात का हमारे कंटेंट पर कोई प्रभुत्व नहीं होगा। BBC की गाइडलाइन्स के अनुसार, “BBC स्वतंत्र है और कोई बाहरी हित उसके संपादकीय अखंडता को प्रभावित नहीं कर सकता; दर्शकों को विश्वास होना चाहिए कि हमारे फैसले राजनीतिक या वाणिज्यिक दबावों से मुक्त हैं”। इसी तर्ज पर हम भी सुनिश्चित करेंगे कि विज्ञापन दाताओं या प्रायोजकों के किसी भी अनुरोध से हमारा संपादकीय विवेक प्रभावित न हो। Yuvakshar की स्वतन्त्रता यह गारंटी देती है कि प्रकाशन में सभी समाचार तथ्यों पर आधारित, संतुलित और निष्पक्ष प्रस्तुति होगी।
          </p>
          ...
          <p className="text-justify font-hindi">
            Yuvakshar की संरचना में विभिन्न भूमिका-स्तर होंगे:
          </p>
          <ul className="list-disc pl-6 space-y-2 font-hindi text-justify">
            ...
            <li>
              <strong>प्रबंध संपादक:</strong> दैनिक प्रकाशन प्रक्रिया को देखेगा। संपादकीय काल-निर्धारण, संसाधन आवंटन और समयबद्ध सम्पादन का निरीक्षण करेगा। EIC के निर्देशानुसार कार्य करेगा।
            </li>
            <li>
            ...
            <li>
              <strong>लेखक/योगदानकर्ता:</strong> Yuvakshar में लेख, समीक्षा, कविताएँ या अन्य सामग्री भेजने वाले प्रेषक। ये नियमित या स्वतंत्र लेखक हो सकते हैं। सभी योगदानकर्ता हमारे लेखन दिशा-निर्देशों का पालन करें, और आवश्यकताओं (जैसे मूलत्व और स्रोत) की गारंटी दें।
            </li>
          </ul>
            ...
            <table className="w-full text-xs sm:text-sm text-left font-hindi">
              ...
              <tbody className="divide-y divide-[#E7E2D8] dark:divide-slate-800">
                <tr>
                  ...
                  <td className="px-4 py-3 text-green-600">हाँ (Admin को चुनना)</td>
                </tr>
                ...
                <tr className="bg-slate-50/30 dark:bg-slate-900/10">
                  ...
                  <td className="px-4 py-3 text-slate-500">कभी-कभी (EIC सलाह से)</td>
                  <td className="px-4 py-3 text-red-500">नहीं</td>
                  <td className="px-4 py-3 text-red-500">नहीं</td>
                </tr>
                <tr>
          ...
          <div className="flex flex-col items-center space-y-3 py-6 max-w-lg mx-auto">
            ...
            <div className="w-full text-center group">
              <div className="bg-white dark:bg-[#0D1527] border-2 border-[#E7E2D8] dark:border-slate-800 rounded-xl p-4 transition-all duration-300 hover:scale-[1.02] hover:border-orange-500 dark:hover:border-orange-500 hover:shadow-lg dark:hover:shadow-orange-500/10">
                ...
                <h3 className="font-hindi font-bold text-slate-900 dark:text-white text-base md:text-lg">
                  प्राथमिक जाँच (Admin द्वारा)
                </h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 font-hindi mt-1">
                  तकनीकी रूप से Admin यह सुनिश्चित करता है कि सबमिशन नियमों के अनुरूप हो।
                </p>
              </div>
            </div>
            ...
            <div className="w-full text-center group">
              <div className="bg-white dark:bg-[#0D1527] border-2 border-[#E7E2D8] dark:border-slate-800 rounded-xl p-4 transition-all duration-300 hover:scale-[1.02] hover:border-orange-500 dark:hover:border-orange-500 hover:shadow-lg dark:hover:shadow-orange-500/10">
                ...
                <h3 className="font-hindi font-bold text-slate-900 dark:text-white text-base md:text-lg">
                  अंतिम संपादन/अनुमोदन (EIC)
                </h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 font-hindi mt-1">
                  मुख्य संपादक (Editor-in-Chief) द्वारा सामग्री का अंतिम अवलोकन एवं प्रकाशन की मंजूरी।
                </p>
              </div>
            </div>
          ...
          <p className="text-justify font-hindi">
            गलतियों की पारदर्शी जाँच और त्वरित सुधार हमारी नीति का अभिन्न अंग है। किसी भी प्रकार की तथ्यात्मक त्रुटि, संपादन में चूक या कानूनी उल्लंघन की स्थिति में, Yuvakshar तुरंत सुधारात्मक कार्रवाई करेगा।
          </p>
          ...
          <p className="font-hindi font-bold text-slate-900 dark:text-white pt-6 mb-4 text-center">
            सुधार प्रक्रिया का प्रवाह (Correction & Retraction Workflow):
          </p>
          ...
          <p className="text-justify font-hindi">
            आधुनिक युग में कृत्रिम बुद्धिमत्ता (AI) उपकरणों का प्रयोग प्रकाशन में बढ़ा है, पर इस पर पारदर्शी नियंत्रण अनिवार्य है। Yuvakshar में AI का उपयोग निम्न स्तरों पर होगा, और प्रत्येक स्तर के लिए प्रकटीकरण अनिवार्य होगा:
          </p>
          <div className="overflow-x-auto border border-[#E7E2D8] dark:border-slate-800 rounded-xl my-4">
            <table className="w-full text-xs sm:text-sm text-left font-hindi">
              <thead className="bg-slate-50 dark:bg-slate-900 border-b border-[#E7E2D8] dark:border-slate-800 text-slate-700 dark:text-slate-350">
          ...
          <p className="text-justify font-hindi">
            किसी भी रिपोर्ट में व्यक्तिगत या संवेदनशील जानकारी का उपयोग भारतीय कानूनों के दायरे में होगा। सूचना प्रसारण के विनियम (IT नियम) और सुप्रीम कोर्ट के रुख के अनुसार, प्रत्येक व्यक्ति को निजता का अधिकार है। Press Council के नियमों में स्पष्ट है कि “व्यक्ति की निजता का उल्लंघन तभी स्वीकार्य है जब उसे वास्तविक जनहित से तौलने पर भारी तौल का परिणाम प्राप्त हो, न कि कोई रोगात्मक जिज्ञासा के कारण”। अतः Yuvakshar व्यक्तिगत डेटा प्रकटीकरण में सावधानी रखेगा।
          </p>
          ...
          <p className="text-justify font-hindi">
            Yuvakshar सभी कानूनी प्रावधानों का पालन करेगा। मानहानि (IPC धारा 499/500), अपमान (IPC 501), अप्रकाशित सामग्री की चोरी, राष्ट्रीय सुरक्षा (IT अधिनियम की धारा 69A इत्यादि) आदि का विशेष ध्यान रखा जाएगा। पत्रकारों को मानहानि कानून की समझ होगी कि बिना ठोस सबूत के किसी की प्रतिष्ठा पर आघात न करें।
          </p>
