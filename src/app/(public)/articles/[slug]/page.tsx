  ...
  if (!article) {
    return (
      <div className="w-full min-h-screen bg-white dark:bg-[#0A0A0A] pb-16 font-sans">
        <AppHeader />
        <div className="max-w-[800px] mx-auto px-4 py-24 text-center my-12 bg-gray-50 dark:bg-gray-900 border border-gray-150 dark:border-gray-850 rounded-lg">
          <h2 className="text-2xl font-serif font-black mb-2 text-gray-850 dark:text-gray-200">
            लेख उपलब्ध नहीं है (Article Not Found)
          </h2>
          <p className="text-sm text-gray-500 max-w-sm mx-auto mb-6">
            हो सकता है कि यह लेख हटा दिया गया हो या इसका यूआरएल (URL) बदल गया हो।
          </p>
          <a 
            href="/" 
            className="inline-block bg-[#f97316] text-white px-5 py-2 rounded text-xs font-bold font-sans"
          >
            मुख्य पृष्ठ पर जाएं
          </a>
        </div>
